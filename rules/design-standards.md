...
- **Strict Rule**: When designing or scaffolding any new web property, the Designer Agent (`@designer`) must explicitly lead Step 2 of site setup (`site-setup` skill) and generate a concrete `DESIGN.md` specification (and `src/styles/tokens.css`).
