...
---
# Skill: /wf-question-formulation — Question Formulation & Strategic Framing

Use this skill to structure and formulate questions that require human opinions, preferences, or design decisions. This workflow is designed to prevent cognitive offloading (i.e., when a recipient copy-pastes a question directly into an AI to let it make the decision or write the answer for them). 
