...
description: Integrates Google's asynchronous coding agent Jules (`@google/jules`) with the workforce execution pipeline. Reach for this skill when discovering active or remote Jules coding sessions, auditing and testing code changes generated by Jules, providing feedback or updates to remote sessions, or syncing Jules task statuses with standup agendas and GitHub PRs.
---
